...
const EmployeeList = () => {
    ...
    const deleteEmployee = (e : React.MouseEvent<HTMLAnchorElement>, id : number) => {
        e.preventDefault();
        EmployeeService.deleteEmployee(id).then((response) => {
            if (employees)
            {
                ...
                {
                    return prevElement.filter((employees : any) => employees.id !== id);
                })
            }
        })
    }
    ...
    return (
        <div className='containe mx-8 my-8'>
            <div className='h-12'>
                <button
            ...
            <div className='flex shadow border-b text-sm sm:text-base'>
